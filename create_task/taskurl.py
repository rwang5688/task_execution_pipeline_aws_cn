...
def generate_preprocess_data_bucket_object_url(user_id, task_id, object_name):
    url = generate_data_bucket_object_url('PREPROCESS_DATA_BUCKET', user_id, task_id, object_name)
    return url
