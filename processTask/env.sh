...
export TASK_EXEC_WRITE_TASK_FILES_QUEUE=task-exec-write-task-files-queue-xcalibyte-com-cn
...
export TASK_EXEC_FILE_TABLE=task-exec-file-table-xcalibyte-com-cn
